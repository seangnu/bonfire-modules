	...
	<div class="view">
        ...
        <div class="scrollable">
            <div class="list-view" id="news-list">
                ...
                <div class="list-item with-icon" data-id="<?php echo $record->id ?>" data-category="<?php if(isset($categories[$record->category_id]->category_name)) echo $categories[$record->category_id]->category_name ?>">
                    &nbsp;&nbsp;<!-- png -->
                    <p>
