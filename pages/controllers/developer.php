...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Pages.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Pages.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_pages())
			{
				...
				Template::redirect(SITE_AREA .'/developer/pages');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Pages.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/pages');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Pages.Developer.Delete');
