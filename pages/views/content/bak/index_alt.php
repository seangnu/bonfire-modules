...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('pages_no_records'); ?> <?php echo anchor(SITE_AREA .'/content/pages/create', lang('pages_create_new'), array("class" => "ajaxify")) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/content/pages/create')?>"><?php echo lang('pages_create_new_button');?></a>
...
foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/content/pages/edit/'. $record->id, lang('pages_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>
