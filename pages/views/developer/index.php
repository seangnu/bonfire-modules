<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/developer/pages/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/developer/pages/edit/'. $record->id, lang('pages_edit'), '') ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
